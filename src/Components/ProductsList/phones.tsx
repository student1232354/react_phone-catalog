...
export const Phones: React.FC<Props> = ({
  ...
  const phoneProducts = array.filter(cobj => cobj.category === 'phones');
  ...
  return (
    <div className="phones-page">
      ...
      <h1 className="Mobile__phones">Mobile phones</h1>
      ...
      {size !== filteredArray.length && (
        <div className="this__buttons">
          ...
          <button
            ...
            disabled={Chuslo === (size === 4 ? 28 : size === 8 ? 12 : 4)}
          >
            {'>'}
          </button>
        </div>
